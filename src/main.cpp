...
const string strMessageMagic = "mehcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // mehcoin: 1 days
static const int64 nTargetSpacing = 120; // mehcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal mehcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa8432fbc6b0409c71d35892c34b5a28c6df5e0f81f2d80decb460a863904bbf7");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Hooray.  Another coin.  Today is special.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388356018; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1388358608;
            block.nNonce   = 85275;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5bc5293fc4786dda57b638fbee76610cd6fd0dfb798fe25338ca55493b93d782"));
